...
const lessons: Record<string, {
  ...
  "5": {
    ...
    content: [
      ...
      { type: "list", items: ["✅ Regulated — ໄດ້ຮັບໃບອະນຸຍາດ FCA, ASIC, CySEC", "✅ ຝາກ-ຖອນ BCEL ໄດ້", "✅ Spread ຕໍ່າ", "✅ Support ພາສາລາວ ຫຼື ໄທ", "✅ ຖອນໄວ"] },
  ...
  "8": {
    ...
    content: [
      ...
      { type: "list", items: ["📈 Uptrend = Higher Highs + Higher Lows → ຊື້ (Buy)", "📉 Downtrend = Lower Highs + Lower Lows → ຂາຍ (Sell)", "↔️ Sideways = ລາຄາໄປມາ → ຫຼີກລ້ຽງ ຫຼື Range Trade"] },
      { type: "tip", text: "💡 ໃຊ້ MA ຊ່ວຍເຫັນ Trend: ລາຄາຢູ່ເໜືອ MA = Uptrend · ລາຄາຢູ່ໃຕ້ MA = Downtrend" },
    ],
  },
  "9": {
    ...
    prev: "8", next: "10",
    content: [
      { type: "text", text: "Market Structure ຄືການອ່ານໂຄງສ້າງຕະຫຼາດໂດຍດູ High ແລະ Low ຂອງລາຄາ" },
  ...
  "10": {
    ...
    prev: "9", next: "11",
    content: [
      { type: "heading", heading: "RSI" },
      { type: "text", text: "RSI ວັດຄວາມແຂງ-ອ່ອນຂອງລາຄາ: ສູງກວ່າ 70 = Overbought · ຕໍ່າກວ່າ 30 = Oversold" },
      { type: "heading", heading: "MACD" },
      { type: "text", text: "MACD ຊ່ວຍຫາ Momentum: MACD ຂ້າມ Signal Line ຂຶ້ນ = Buy · ຂ້າມລົງ = Sell" },
      { type: "heading", heading: "Moving Average (MA)" },
      { type: "text", text: "MA ສະແດງລາຄາສະເລ່ຍ ຊ່ວຍເຫັນ Trend: MA 20 ຂ້າມ MA 50 ຂຶ້ນ = Buy Signal" },
  ...
  "11": {
    ...
    prev: "10", next: "12",
    content: [
      { type: "text", text: "Risk Management ຄືການຄຸ້ມຄອງຄວາມສ່ຽງ — ຫຼາຍຄົນຂາດທຶນເພາະ Risk Management ບໍ່ດີ ບໍ່ແມ່ນ Strategy ຜິດ" },
      { type: "heading", heading: "ກົດ 1% Rule" },
      { type: "text", text: "ຢ່າສ່ຽງເກີນ 1-2% ຂອງ Account ຕໍ່ 1 Trade · Account $1,000 → ສ່ຽງໄດ້ສູງສຸດ $10-$20" },
  ...
  "12": {
    ...
    content: [
      ...
      { type: "text", text: "ຄວນໃຊ້ RR ຢ່າງໜ້ອຍ 1:2 ໝາຍຄວາມວ່າ ສ່ຽງ 10 Pip → ກໍາໄລ 20 Pip" },
  ...
  "13": {
    ...
    content: [
      ...
      { type: "list", items: ["ຈໍານວນ Trade ຕໍ່ວັນ: ສູງສຸດ 3-5 Trade", "% ສ່ຽງຕໍ່ Trade: 1-2% ຂອງ Account", "ສ່ຽງລວມຕໍ່ວັນ: ສູງສຸດ 5%", "ຖ້າຂາດທຶນ 3 Trade ຕິດກັນ: ຢຸດເທຣດວັນນັ້ນ"] },
      { type: "tip", text: "💡 ຂຽນ Plan ລົງເຈ້ຍ ແລ້ວຕິດໄວ້ໃກ້ Computer" },
    ],
  },
  "14": {
    ...
    content: [
      ...
      { type: "list", items: ["ຫຼຸດ Lot Size ລົງທັນທີ", "ທົບທວນ Strategy ວ່າຜິດຫຍັງ", "ຢ່າ Revenge Trade", "ພັກ 1-2 ວັນ ກ່ອນກັບມາ"] },
  ...
  "15": {
    ...
    prev: "14", next: "16",
    content: [
      { type: "text", text: "Position Sizing ຄືການຄໍານວນ Lot Size ທີ່ເໝາະສົມ ໂດຍອ້າງອີງຈາກ Account Size ແລະ ຄວາມສ່ຽງ" },
      ...
      { type: "tip", text: "💡 ໃຊ້ Lot Calculator ໃນ XM ຫຼື Exness ຊ່ວຍຄໍານວນໄດ້ຄ່ອຍ" },
    ],
  },
  "16": {
    ...
    prev: "15", next: "17",
    content: [
      { type: "text", text: "ບັນຊີ Demo ຄືບັນຊີຝຶກຫັດ ໃຊ້ເງິນສົມມຸດ — ເທຣດໄດ້ຄືເງິນຈິງ ແຕ່ບໍ່ສ່ຽງເງິນຕົວເອງ" },
  ...
  "17": {
    ...
    prev: "16", next: "18",
    content: [
      { type: "text", text: "ໂບກເກີ້ທີ່ຮັບ BCEL ສໍາລັບຄົນລາວ: XM, Exness, IUX, Vantage, HFM, Market4you" },
      { type: "list", items: ["1. Login ໂບກເກີ້ → ໄປ Deposit", "2. ເລືອກ Local Bank Transfer", "3. ໃສ່ຈໍານວນ USD ທີ່ຕ້ອງການ", "4. ໂອນຜ່ານ BCEL One ຫຼື Counter", "5. Upload Slip → ເງິນເຂົ້າ 15-60 ນາທີ"] },
  ...
  "18": {
    ...
    content: [
      ...
      { type: "list", items: ["1. ເປີດ MT4/MT5 → ຊອກ EURUSD", "2. ຄລິກຂວາ → New Order", "3. ເລືອກ Type: Market Execution", "4. ໃສ່ Volume: 0.01 (Micro)", "5. ຕັ້ງ Stop Loss ແລະ Take Profit", "6. ກົດ Buy ຫຼື Sell"] },
  ...
  "20": {
    ...
    content: [
      ...
      { type: "list", items: ["ວັນທີ ແລະ ເວລາ Trade", "ຄູ່ເງິນ ແລະ ທິດ (Buy/Sell)", "Lot Size · Entry · SL · TP", "ຜົນ: ກໍາໄລ ຫຼື ຂາດທຶນ", "ເຫດຜົນທີ່ເທຣດ", "ຄວາມຮູ້ສຶກ ແລະ ບົດຮຽນ"] },
      { type: "tip", text: "💡 ທົບທວນ Journal ທຸກ 2 ອາທິດ — ຈະເຫັນ Pattern ຂອງຄວາມຜິດພາດ" },
    ],
  },
};
        ...
        <div className="space-y-5">
          {lesson.content.map((block, i) => {
            ...
            if (block.type === "text") return (
              <p key={i} className="text-gray-300" style={{ lineHeight: "2" }}>{block.text}</p>
            );
